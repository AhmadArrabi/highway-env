...
class VehicleGraphics(object):
    ...
    def display(cls, vehicle: Vehicle, surface: "WorldSurface",
        ...
        v = vehicle
        tire_length, tire_width = 4, 1 #1, 0.3
        ...
        pygame.draw.rect(vehicle_surface, (255,255,255), rect_headlight_left, 0)#cls.lighten(color)
        pygame.draw.rect(vehicle_surface, (255,255,255), rect_headlight_right, 0)#cls.lighten(color)
        if draw_roof:
        ...
        if type(vehicle) in [Vehicle, BicycleVehicle]:
            ...
            for tire_position, tire_angle in zip(tire_positions, tire_angles):
                ...
                pygame.draw.rect(tire_surface, (255,255,255), rect, 0)#cls.BLACK
    ...
    def get_color(cls, vehicle: Vehicle, transparent: bool = False) -> Tuple[int]:
        ...
        if getattr(vehicle, "color", None):
            ...
            color = cls.RED #AHMAD YELLOW->RED
